...
* **Current:** Multimodal Learning, Robustness, Biomedical AI
  
연구 초기에는 Meta Learning을 보다가, 최근에는 Multimodal 관련한 연구를 하고 있습니다. Multimodal 관점에서 이론적으로 규명하고 이를 robustness 관점에서 해석하는 연구를 진행 중입니다. 또한 최근에는 **Biomedical AI**에 관심이 생겨 bio-signal (EEG) + AI쪽 연구도 병행하고 있습니다.

저의 목표는 좋은 성능의 모델 만드는 것의 연구를 넘어, **"확실한 이론적/수학적 근거를 바탕으로 AI를 이해하고 이를 원활하게 소통하는 연구자"**가 되는 것입니다. 때론 intuitive하게, 때론 이론적으로 모델의 동작 원리를 규명하고, 복잡한 공학적 개념을 대중에게 직관적이고 친근하게 전달하는 박사가 되고 싶습니다.
